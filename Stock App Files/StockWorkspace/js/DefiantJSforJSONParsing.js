...
if (function (e, t) {
        var n = {
            init: function () {
                ...
                var r = e.URL || e.webkitURL, a = "var tree = {" + this.parse(t).join(",") + "};",
...
String.prototype.fill || (String.prototype.fill = function (e, t) {
    ...
    var n, r, a, s = {
        ...
        hash_to_xml: function (e, t, n) {
            var r, a, s, o, i, l, c, u, d, h = t.constructor === Array, p = this, m = [], f = [], g = function (t, r) {
                if (a = r[t], null !== a && void 0 !== a && "NaN" !== a.toString() || (a = null), o = "@" === t.slice(0, 1), i = n ? e : t, i == +i && r.constructor !== Object && (i = "d:item"), null === a ? (l = null, c = !1) : (l = a.constructor, c = l.toString().match(p.rx_function)[1]), o) f.push(i.slice(1) + '="' + p.escape_xml(a) + '"'), "String" !== c && f.push("d:" + i.slice(1) + '="' + c + '"'); else if (null === a) m.push(p.scalar_to_xml(i, a)); else switch (l) {
                    case Function:
            ...
            if (t.constructor === Array) for (u = 0, d = t.length; u < d; u++) g(u.toString(), t); else for (r in t) g(r, t);
    ...
    "use strict";
    var r, a, s = e.doc && e.doc.nodeType, o = s ? e.doc : JSON.toXML(e), i = s ? e.map : this.search.map,
        l = s ? e.src : e, c = Defiant.node[n ? "selectSingleNode" : "selectNodes"](o, t.xTransform()), u = [];
    ...
    "use strict";
    var n = function (e) {
        var t, r, a, s, o, i, l, c, u, d, h = {}, p = window;
        switch (e.nodeType) {
            case 1:
